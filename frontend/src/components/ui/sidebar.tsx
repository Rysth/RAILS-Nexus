...
function SidebarProvider({
  ...
  const getCookieDefaultOpen = React.useCallback(() => {
  ...
  const [_open, _setOpen] = React.useState(getCookieDefaultOpen);
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        "data-[active=true]:bg-sidebar-accent mt-1.5 w-[15.30rem] md:!w-50 data-[active=true]:text-sidebar-accent-foreground data-[active=true]:font-semibold",
        size === "sm" && "text-xs",
        size === "md" && "text-sm",
        "group-data-[collapsible=icon]:hidden",
        className,
