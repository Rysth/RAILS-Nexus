...
interface QuotesDataTableProps<TData, TValue> {
...
export function QuotesDataTable<TData, TValue>({
  columns,
  data,
  onCreateQuote,
  onFilterChange,
  ...
  isLoading,
  pagination,
}: QuotesDataTableProps<TData, TValue>) {
  ...
  const hasActiveFilters = searchValue !== "" || selectedStatus !== "";
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button variant="outline" size="sm">
                    {selectedStatus === ""
                      ? "Estado"
                      : QUOTE_STATUSES.find((s) => s.value === selectedStatus)
                          ?.label || "Filtrar"}
